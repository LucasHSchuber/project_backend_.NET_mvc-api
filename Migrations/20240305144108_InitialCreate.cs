        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageName = table.Column<string>(type: "TEXT", nullable: true),
                    ImageNameOriginal = table.Column<string>(type: "TEXT", nullable: true),
                    Created = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UploaderUser = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AudiosAudioID = table.Column<int>(type: "INTEGER", nullable: false),
                    UsersUserId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AudioUser", x => new { x.AudiosAudioID, x.UsersUserId });
                    table.ForeignKey(
                        name: "FK_AudioUser_Audio_AudiosAudioID",
                        column: x => x.AudiosAudioID,
                        principalTable: "Audio",
                        principalColumn: "AudioID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AudioUser_User_UsersUserId",
