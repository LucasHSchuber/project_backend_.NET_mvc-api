        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AudioData = table.Column<byte[]>(type: "BLOB", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Audio", x => x.AudioID);
                    table.ForeignKey(
                        name: "FK_Audio_Category_CategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserList", x => x.ListID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserListAudioID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ListID = table.Column<int>(type: "INTEGER", nullable: false),
                    AudioID = table.Column<int>(type: "INTEGER", nullable: false),
                    UserListListID = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserListAudio", x => x.UserListAudioID);
                    table.ForeignKey(
                        name: "FK_UserListAudio_Audio_AudioID",
                        column: x => x.AudioID,
                        principalTable: "Audio",
                        principalColumn: "AudioID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserListAudio_UserList_UserListListID",
                        column: x => x.UserListListID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Audio_CategoryID",
                table: "Audio",
                column: "CategoryID");

            migrationBuilder.CreateIndex(
                name: "IX_Like_AudioID",
                table: "Like",
                column: "AudioID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserListAudio_AudioID",
                table: "UserListAudio",
                column: "AudioID");

            migrationBuilder.CreateIndex(
                name: "IX_UserListAudio_UserListListID",
                table: "UserListAudio",
                column: "UserListListID");
        }
