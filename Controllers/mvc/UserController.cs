...
namespace projekt_webbservice.Controllers.mvc
{
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Username,Email,PasswordHash,UserInfo,ImageName")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Username,Email,PasswordHash,UserInfo,ImageName")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
